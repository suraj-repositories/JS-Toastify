...
// REMOVE THIS PART TO USE THIS IN YOUR PROJECT  --- START ---

Toastify.error("This is an error message!", 5000);
Toastify.success("This is an error message!", 5000);
Toastify.warning("This is an error message!", 5000);
Toastify.info("This is an error message!", 5000);
